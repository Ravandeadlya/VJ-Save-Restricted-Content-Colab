...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("𝐖𝐎𝐎𝐃𝐜𝐫𝐚𝐟𝐭", url = "https://t.me/Rotiyog")
    ],[
        InlineKeyboardButton('🔍 WD Topic Group', url='https://t.me/hgd85g'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/hgd85g')
	]]
